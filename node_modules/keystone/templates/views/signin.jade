		...
		.auth-box-col
			if user
				...
				form(method="post", novalidate).auth-form
					...
					button(type='submit' style="display: block").btn.btn-primary Sign In

					a(href="/social/facebook/login" style="width: 50%; padding-top: 20px")
						img(src="/images/11405239_920140564714397_256329502_n.png" style="width: 50%; padding-top: 20px")

					a(href="/social/google/login" style="width: 50%; padding-top: 20px")
						img(src="/images/btn_google_signin_light_normal_web.png" style="width: 50%; padding-top: 20px")
